 ...
 * Date: ${.now}
 */
public class ${classNamePrefix}Fragment extends com.github.pingia.ui.framework.base.BaseNoBlockLoadingFragment<I${busiName}Contract.Presenter> implements I${busiName}Contract.View
{
